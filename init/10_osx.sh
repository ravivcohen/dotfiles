...
if [[ "$new_dotfiles_install" ]]; then
 ...
 open "~/.dotfiles/link/.oh-my-zsh-custom/custom/terminal/Solarized_Dark_Ver2.terminal"
 sleep 1 # Wait a bit to make sure the theme is loaded
 open "~/.dotfiles/link/.oh-my-zsh/custom-custom/terminal/Solarized_Dark.terminal"
